...
{
GlobalLocalizationNewBBS::GlobalLocalizationNewBBS(ros::NodeHandle& private_nh) : private_nh(private_nh) {
...
GlobalLocalizationNewBBS ::~GlobalLocalizationNewBBS() {}

void GlobalLocalizationNewBBS::set_global_map(pcl::PointCloud<pcl::PointXYZ>::ConstPtr cloud) {
  BBSParams params;
  ...
  bbs.reset(new NewBBSLocalization(params));
...
GlobalLocalizationResults GlobalLocalizationNewBBS::query(pcl::PointCloud<pcl::PointXYZ>::ConstPtr cloud, int max_num_candidates) {
...
GlobalLocalizationNewBBS::Points2D GlobalLocalizationNewBBS::slice(const pcl::PointCloud<pcl::PointXYZ>& cloud, double min_z, double max_z) const {
  Points2D points_2d;
...
pcl::PointCloud<pcl::PointXYZ>::Ptr GlobalLocalizationNewBBS::unslice(const Points2D& points) {
